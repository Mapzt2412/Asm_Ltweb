<?php 
	...
	$product = getNewsById($_SESSION["newsId"]);
	if(isset($_POST["submit"])){
        $imageUrl = $_POST["imageUrl"];
		$url = $_POST["url"];
		$category = $_POST["category"];
		$note = $_POST["note"];
		updateNews($_SESSION["newsId"],$imageUrl, $url, $category, $note);
...
<head>
    ...
    <title>Sửa tin tức"<?php echo $product["title"]?>"</title>
	...
	<div class="container">
        <form method="POST" action="">
                <div class="form-group row">
					...
					<div class="col-9">
						<input type="text" class="form-control col-9" name="note"id="note" value="<?php echo $product["note"] ?>">
					</div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9">
                        <input type="text" class="form-control col-9" name="imageUrl"id="author" value="<?php echo $product["imageUrl"] ?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
					...
					<div class="col-9">
						<input type="text" class="form-control col-9" name="url"id="url" value="<?php echo $product["url"] ?>">
					</div>
                </div>
