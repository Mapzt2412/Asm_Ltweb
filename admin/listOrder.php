...
<body>
    ...
    <table class="table">
            ...
            <?php foreach($result1 as $result1): ?>
                <tr>
                <td>
                <a href="listOrder.php?delete=<?php echo $result1["id"]?>"class="nav-link"> Xóa</a>
                </td>
                <td><?php echo $result1["id"]?></td>
                <td><?php echo $result1["customerName"]?></td>
                <td><?php echo $result1["address"]?></td>
                <td>0<?php echo $result1["phoneNumner"]?></td>
                <td><?php echo $result1["productName"]?></td>
                <td><?php echo $result1["productQuantily"]?></td>
            ...
            <?php endforeach;?>
                ...
                <ul class="pagination justify-content-end">
                        <li class="page-item "><a class="page-link" href="listOrder.php?page=<?php echo $current_page-1; ?>">Previous</a></li>
                        <?php 
                            for($i = 0; $i<  $total_page ; $i++){
                        ?>
                        <li class="page-item "><a class="page-link" href="listOrder.php?page=<?php echo $i+1; ?>"><?php echo $i+1; ?></a></li>
                        <?php } ?>
                        <li class="page-item"><a class="page-link" href="listOrder.php?page=<?php echo $current_page+1; ?>">Next</a></li>
                </ul>
